...
/**
 * LoginView provides the login interface for the hotel management system.
...
public class LoginView extends JFrame {
    ...
    // Stores currently logged-in user globally
    public static User loggedInUser;

    /**
     * Constructs the login view UI.
     */
    public LoginView() {
    ...
    private void handleLogin() {
        ...
        if (loggedInUser != null) {
            ...
            dispose();
            UserRole role = UserRoleFactory.getRole(loggedInUser);
    ...
    /**
     * Displays a popup for failed login attempt.
     */
    ...
    /**
     * Displays a popup for successful login.
     */
    ...
    /**
     * Entry point for launching the login view.
     */
